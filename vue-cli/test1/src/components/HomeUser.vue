<template>
  <section>
    ...
    <div class="user__image">
      <img class="user__image-img" :src="img" alt="User avatar">
    </div>
  </section>
</template>
...
.front {
  ...
  background-image: linear-gradient(to right, #f5af19, #f12711); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
.end {
  background-clip: text;
  color: transparent;
  background-color: #2980B9;  /* fallback for old browsers */
  background-image: linear-gradient(to left, #FFFFFF, #6DD5FA, #2980B9); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
.user__info, .user__image {
  flex: 1;
}
.user__info-text {
  margin-bottom: 16px;
